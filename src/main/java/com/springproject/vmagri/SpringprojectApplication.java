...
import com.springproject.vmagri.domain.ItemPedido;
...
import com.springproject.vmagri.repositories.ItemPedidoRepository;
...
public class SpringprojectApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat6 = new Categoria(null, "decorcao");
		...
		Cliente cli1 = new Cliente(null, "Maria da Silva", "maria.silva@gmail.com", "23456734598",
				TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("44563212", "987654434"));

		Cliente cli2 = new Cliente(null, "Amanda Castelli", "castellia@gmail.com", "22344567891",
				TipoCliente.PESSOAFISICA);
		...
		Pagamento pag1 = new PagamentoCartao(null, StatusPagamento.EFETUADO, ped1, 6,
				datePattern.parse(datePattern.format(new Date())));
		ped1.setPagamento(pag1);

		Pagamento pag2 = new PagamentoBoleto(null, StatusPagamento.PENDENTE, ped2,
				datePattern.parse("20/10/2017 00:00"), null);
